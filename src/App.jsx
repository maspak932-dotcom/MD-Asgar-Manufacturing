...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#f7f4ef] text-slate-900 overflow-x-hidden font-sans antialiased">

      {/* ================= NAVBAR ================= */}
      <nav className="bg-black/95 backdrop-blur-md sticky top-0 z-50 border-b border-zinc-800">
        <div className="max-w-7xl mx-auto px-5 md:px-8 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-gray-300 text-sm font-medium">
            ...
            <a href="#premium" className="hover:text-yellow-400 transition-colors">Premium</a>
          ...
          <div className="flex gap-4 md:gap-5">
            {[
              ...
              <a key={i} href={href} target="_blank" rel="noreferrer" className="text-gray-400 hover:text-yellow-400 transition-colors">
                <Icon size={19} />
              </a>
            ))}
          </div>
        ...
        <div className="text-center px-5 py-16 md:py-24 bg-black">
          ...
          <div className="flex items-center justify-center gap-4 mt-12 flex-wrap">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-3 bg-yellow-500 hover:bg-yellow-400 text-black px-8 py-4 rounded-2xl font-bold text-base md:text-lg transition-all duration-300 shadow-lg shadow-yellow-500/25 hover:-translate-y-0.5"
            >
              Contact On WhatsApp
        ...
        {[
          {
            ...
            desc: "Durable trolley bags with reinforced stitching and premium-grade material — built to survive real travel."
          },
          {
            Icon: Recycle,
            color: "text-green-600",
            title: "Eco Friendly",
            desc: "Sustainable materials and responsible manufacturing focused on long-lasting products."
          },
          {
            Icon: Package,
            color: "text-blue-600",
            title: "Direct Wholesale",
            desc: "No middlemen. Direct manufacturer pricing for retailers, wholesalers and bulk buyers."
          }
        ].map((item, i) => (
          <div
            key={i}
      ...
      {/* ================= PREMIUM SHOWCASE ================= */}
      <section id="premium" className="w-full mt-10 mb-6 px-5 md:px-8">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            ...
            <div className="space-y-4">
              <a href={`tel:${contactNumber}`} className="flex items-center gap-4 bg-zinc-900/80 border border-zinc-800 p-5 rounded-2xl hover:border-yellow-500/40 transition-all group">
              ...
              <a href={`mailto:${contactEmail}`} className="flex items-center gap-4 bg-zinc-900/80 border border-zinc-800 p-5 rounded-2xl hover:border-yellow-500/40 transition-all group">
                <div className="bg-yellow-500/15 p-3 rounded-xl group-hover:bg-yellow-500/25 transition-colors">
